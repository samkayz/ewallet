...
// Calculate and within abuja 
$('#within-abuja').click(function () {
    $("#locationform").slideUp();
    $("#abujaform").fadeIn();
});

$('#backFromAbuja').click(function () {
    $("#locationform").slideDown();
    $("#abujaform").fadeOut();
});
// Calculate and within lagos 
$('#within-lagos').click(function () {
    $("#locationform").slideUp();
    $("#lagosform").fadeIn();
});

$('#backFromLagos').click(function () {
    $("#locationform").slideDown();
    $("#lagosform").fadeOut();
});
// Calculate and interstate 
$('#inter-state').click(function () {
    $("#locationform").slideUp();
    $("#stateform").fadeIn();
});
$('#backFromStates').click(function () {
    $("#locationform").slideDown();
    $("#stateform").fadeOut();
});
// Update 1.5
